...
var ModalTemplate = require('raw-loader!../templates/Modal.html');
...
module.exports = Backbone.View.extend({
    ...
    submit: function (event) {
        ...
        switch (elementType) {
            case 'folder':
                collection = window.App.collections.folders;
                break;
            case 'notepad':
                collection = window.App.collections.notepads;
                break;
            case 'note':
                collection = window.App.collections.notes;
                break;
        }
    ...
    getElementsList: function (elementType) {
        ...
        switch (elementType) {
            ...
            case 'notepad':
                ...
                break;
            case 'note':
                parentId = window.App.collections.notepads.active.get('id');
                break;
        }
        ...
        window.App.collections.folders.processTree(function (folder, lvl) {
            ...
            if (elementType == 'note') {
                ...
                window.App.collections.notepads.each(function (notepad) {
